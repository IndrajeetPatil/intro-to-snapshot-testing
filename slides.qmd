...
To create tests, we call `record_test()` directly on a shiny app object, and then copy-paste the commands to test script, and then run `devtools::test_active_file()` to generate snapshots.
