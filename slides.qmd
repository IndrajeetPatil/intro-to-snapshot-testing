...
If the function changes, the snapshots doesn't match the expected ones, and test will fail:
...
If the function changes, the new output doesn't match the expected one, and the test will fail:
