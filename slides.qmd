...
The *first time* you run the test, it would generate an `.svg` file with expected graphical output.
...
It's not all is kittens and roses when it comes to snapshot testing. We will now see some issues you might run into while using them. 🤕
