...
This testing workflow is also relevant for frameworks (e.g. [`{golem}`](https://thinkr-open.github.io/golem/index.html), [`{rhino}`](https://appsilon.github.io/rhino/), etc.) that produce production-ready Shiny apps. 
...
The final location of the tests and snapshots should look like the following for the two possible ways Shiny apps in R packages.
