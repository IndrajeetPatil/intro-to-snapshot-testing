...
- [Link to slides](https://indrajeetpatil.github.io/intro-to-snapshot-testing/){target="_blank"}
- [Github repo](https://github.com/IndrajeetPatil/intro-to-snapshot-testing/){target="_blank"}
...
To create graphical expectations, we will use `{testthat}` extension package: [`{vdiffr}`](https://vdiffr.r-lib.org/){target="_blank"}.
...
To write formal tests for Shiny applications, we will use `{testthat}` extension package: [`{shinytest2}`](https://rstudio.github.io/shinytest2/){target="_blank"}.
