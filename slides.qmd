...
`{shinytest2}` uses a Shiny app[^2] to record your interactions with the app and generates snapshots of the application's state. Future behaviour of the app will be compared against these snapshots to check for any changes.
...
Make sure that the application is stored in a single `app.R` file.
