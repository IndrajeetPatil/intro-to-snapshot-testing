...
`{shinytest2}` uses a Shiny app[^1] to record your interactions with the app and generates snapshots of the application's state. Future behaviour of the app will be compared against these snapshots to check for any changes.
