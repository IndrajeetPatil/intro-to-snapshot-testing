...
## Introduction to Snapshot Testing in R {style="margin-top: 3em;"}

::: {style="margin-top: 2em; margin-bottom: 1em; font-size: 0.75em"}

Indrajeet Patil

Software Engineer, [cynkra](https://www.cynkra.com/)
...
- [Link to slides](https://indrajeetpatil.github.io/intro-to-snapshot-testing/)
- [Github repo](https://github.com/IndrajeetPatil/intro-to-snapshot-testing/)

:::

![](media/logos_combined.jpeg){.absolute width="500" height="200" right="100" top="100"}
...
In other words, *your* tests are now at the mercy of *other package authors* because snapshots are capturing things beyond your package's purview.

:::{.callout-caution}

Tests that fail for reasons other than what they are testing for are problematic. Thus, be careful about *what* you snapshot and maintenance burden that comes with dependencies with volatile APIs.
